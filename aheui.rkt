...
(define (run-aheui cmds pos-x pos-y prev-x prev-y direction storage-no storage)
  ...
  (cond ((equal? cmd1 "ㅏ") (run-aheui cmds (+ pos-x 1) pos-y pos-x pos-y 1 new-storage-no storage))
        ((equal? cmd1 "ㅓ") (run-aheui cmds (- pos-x 1) pos-y pos-x pos-y -1 new-storage-no storage))
        ((equal? cmd1 "ㅗ") (run-aheui cmds pos-x (- pos-y 1) pos-x pos-y -2 new-storage-no storage))
        ((equal? cmd1 "ㅜ") (run-aheui cmds pos-x (+ pos-y 1) pos-x pos-y 2 new-storage-no storage))
        ((equal? cmd1 "ㅑ") (run-aheui cmds (+ pos-x 2) pos-y pos-x pos-y 1 new-storage-no storage))
        ((equal? cmd1 "ㅕ") (run-aheui cmds (- pos-x 2) pos-y pos-x pos-y -1 new-storage-no storage))
        ((equal? cmd1 "ㅛ") (run-aheui cmds pos-x (- pos-y 2) pos-x pos-y -2 new-storage-no storage))
        ((equal? cmd1 "ㅠ") (run-aheui cmds pos-x (+ pos-y 2) pos-x pos-y 2 new-storage-no storage))
        ((equal? cmd1 "ㅡ")
